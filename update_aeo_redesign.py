...
with open('d:/Zippy/Akkurate/update_pages.py', 'r', encoding='utf-8') as f:
    content = f.read()

new_content = '''AEO_CONTENT = """
            <!-- ==================== Hero Start Here ==================== -->
            <style>
            .premium-heading {
...
with open('d:/Zippy/Akkurate/update_pages.py', 'w', encoding='utf-8') as f:
    f.write(updated_content)

print('Updated update_pages.py successfully')
